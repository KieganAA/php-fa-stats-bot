...
class ComparisonFormatterTest extends TestCase
{
    public function test_two_entries_get_delta_column(): void
    {
        $html = (new ComparisonFormatter)->format($this->window(), [
            ['label' => '#A', 'metrics' => ['Q Visits' => 100, 'Leads' => 8]],
            ['label' => '#B', 'metrics' => ['Q Visits' => 400, 'Leads' => 22]],
        ]);
    ...
    {
        $html = (new ComparisonFormatter)->format($this->window(), [
            ['label' => '#A', 'metrics' => ['Q Visits' => 1]],
            ['label' => '#B', 'metrics' => ['Q Visits' => 2]],
            ['label' => '#C', 'metrics' => ['Q Visits' => 3]],
        ]);
    ...
    {
        $html = (new ComparisonFormatter)->format($this->window(), [
            ['label' => '#A', 'metrics' => ['Q Visits' => 0, 'Leads' => 0]],
            ['label' => '#B', 'metrics' => ['Q Visits' => 10, 'Leads' => 0]],
        ]);
